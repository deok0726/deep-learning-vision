...
flags.DEFINE_integer('class_id', None, 'Class ID.')
flags.DEFINE_integer('target_id', None, 'Target ID.')
flags.DEFINE_string('class_name', '', 'Class Name')
  ...
  if bbox_annotations:
    ...
    for object_annotations in bbox_annotations:
      ...
      if width <= 0 or height <= 0:
        ...
        print("Image info log %s(id: %d)"%(filename, image_id))
        print("Image size info log %.2f,%.2f"%(image_width, image_height))
        print("BBOX info log %.2f,%.2f,%.2f,%.2f"%(x, y, width, height))
        print()
...
def _load_object_annotations(object_annotations_file):
  ...
  obj_ann_categories = [
    {"id": 1, "name": "CL","supercategory": ""},
    {"id": 2, "name": "CC","supercategory": ""},
    {"id": 3, "name": "SD","supercategory": ""},
    {"id": 4, "name": "BK","supercategory": ""},
    {"id": 5, "name": "LP","supercategory": ""},
    {"id": 6, "name": "JF","supercategory": ""},
    {"id": 7, "name": "JD","supercategory": ""},
    {"id": 8, "name": "DS","supercategory": ""},
    {"id": 9, "name": "ETC","supercategory": ""},
    {"id": 10, "name": "PJ","supercategory": ""},
    {"id": 11, "name": "IN","supercategory": ""},
    {"id": 12, "name": "CAR","supercategory": ""},
    {"id": 13, "name": "INV","supercategory": ""},
    {"id": 14, "name": "HL","supercategory": ""}]
  ...
  #   if not annotation["category_id"] == FLAGS.target_id:
  #     print('skip', annotation )
  #     continue
  #   else:
  #     annotation["category_id"] = FLAGS.class_id
  #   image_id = annotation['image_id']

  #   img_to_obj_annotation[image_id].append(annotation)
  ex_annotation = []
  for annotation in obj_annotations['annotations']:
    if not annotation["category_id"] in range(1,15):
      print('skip', annotation )

      ex_annotation.append(annotation)
  ...
  # print(ex_annotation)
  # with open("ex_annotation.json", "w") as json_file:
  #   json.dump(ex_annotation, json_file)
