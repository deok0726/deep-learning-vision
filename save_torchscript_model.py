...
if __name__ == "__main__":
    ...
    automkdir(torchscript_model_save_path)
    # traced_cell.save(os.path.join(torchscript_model_save_path, 'torchscript_model.zip'))
    # loaded = torch.jit.load(os.path.join(torchscript_model_save_path, 'torchscript_model.zip'))
    # print(loaded)
    # print(loaded.code)
    traced_cell.save(os.path.join(torchscript_model_save_path, 'torchscript_model.pt'))
    # torch.save(model, os.path.join(torchscript_model_save_path, 'torchscript_model.pt'), _use_new_zipfile_serialization=False)
