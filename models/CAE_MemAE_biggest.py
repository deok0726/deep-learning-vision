...
class Model(nn.Module):
    def __init__(self, n_channels, input_height, input_width, mem_dim=100):
        ...
        self.memory_module = MemoryModule(mem_dim=mem_dim, fea_dim=self.conv_channel_num*8, input_h=self.input_h, input_w=self.input_w)
    ...
    def forward(self, x):
        ...
        embedding = f['output'].view(-1, self.conv_channel_num*8, self.input_h, self.input_w)
